(function(c, d) {
            c.widget("ui.rotatable", c.ui.mouse, {
                    ...
                    performRotation: function(a) {
                            ...
                            //added by me - save rotation angle info
                            var id = $(this.element).parent().attr('id');
                            var classes = $(this.element).parent().attr('class');
debugger;
                            if(classes.includes('front')){
                                    listShapeFront[id].degree = a;
                            }else if(classes.includes('profile')){
                                    listShapeProfile[id].degree = a;
                            }
